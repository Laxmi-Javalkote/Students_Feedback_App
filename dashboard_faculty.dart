...
void main(){
  runApp(DashboardFaculty());
}

class DashboardFaculty extends StatefulWidget {

  @override
  DashboardFacultyState createState() => DashboardFacultyState();
}

class DashboardFacultyState extends State<DashboardFaculty> {
...
class DashboardFaculty extends StatelessWidget{
  const DashboardFaculty({Key? key}) : super(key:key);
  @override
  Widget build(BuildContext context) => Scaffold(
    appBar:AppBar(
      title:const Text('Faculty Feedback Analysis Dashboard'),
      ...
      child: Column(
        children: [
          ListTile(
            ...
            title:const Text('Database Systems TE A 2024-25'),
            onTap: () =>
                Navigator.of(context).push(MaterialPageRoute(builder: (context)=>const DB1(),)),
          ),
          ListTile(
            //leading: const Icon(Icons.home_outlined),
            title:const Text('Design And Analysis Of Algorithm SE A 2024-25'),
            onTap: () =>
                Navigator.of(context).push(MaterialPageRoute(builder: (context)=>const DB2(),)),
          ),
        ],
